...
ARG NEXT_PUBLIC_LIVEBLOCKS_ENABLED
...
RUN echo "NEXT_PUBLIC_OPENAI_API_KEY=${NEXT_PUBLIC_OPENAI_API_KEY}" >> .env && \
    echo "NEXT_PUBLIC_ANTHROPIC_API_KEY=${NEXT_PUBLIC_ANTHROPIC_API_KEY}" >> .env && \
    ...
    echo "NEXT_PUBLIC_LIVEBLOCKS_ENABLED=${NEXT_PUBLIC_LIVEBLOCKS_ENABLED}" >> .env && \
