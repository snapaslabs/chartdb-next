...
import { ShareLinkDialog } from '@/dialogs/share-link-dialog/share-link-dialog';
    ...
    return (
        <dialogContext.Provider
            value={{
                ...
                openShareLinkDialog: () => setOpenShareLinkDialog(true),
                closeShareLinkDialog: () => setOpenShareLinkDialog(false),
            }}
        >
            {children}
            <CreateDiagramDialog
            ...
            <ShareLinkDialog dialog={{ open: openShareLinkDialog }} />
        </dialogContext.Provider>
    );
};
