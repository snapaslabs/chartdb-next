...
import { findOverlappingTables } from '@/page-components/editor-page/canvas/canvas-utils';
...
} from '@/page-components/editor-page/canvas/create-relationship-node/create-relationship-node';
