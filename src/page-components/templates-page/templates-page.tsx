...
const TemplatesPageComponent: React.FC<TemplatesPageComponentProps> = ({
    templates,
    allTags,
}) => {
    ...
    const isFeatured = pathname === '/templates/featured';
    const isAllTemplates = pathname === '/templates';
...
export const TemplatesPage: React.FC<TemplatesPageProps> = ({
    ...
    <LocalConfigProvider>
        <ThemeProvider>
            <TemplatesPageComponent templates={templates} allTags={allTags} />
        </ThemeProvider>
    </LocalConfigProvider>
);
