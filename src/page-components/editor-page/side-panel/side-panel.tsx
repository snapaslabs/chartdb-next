...
import { CollaboratorsSection } from './collaborators-section/collaborators-section';
...
export const SidePanel: React.FC<SidePanelProps> = () => {
    ...
    const { user } = useUser();
    const isOwner = !!user && currentDiagram?.ownerId === user.id;
    ...
    return (
        <aside className="flex h-full flex-col overflow-hidden">
            ...
            {selectedSidebarSection === 'tables' ? (
                ...
                <VisualsSection />
            ) : selectedSidebarSection === 'collaborators' ? (
