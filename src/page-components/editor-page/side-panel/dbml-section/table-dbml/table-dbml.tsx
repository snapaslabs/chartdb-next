...
export const TableDBML: React.FC<TableDBMLProps> = () => {
    ...
    const decorationsCollection =
        useRef<monaco.editor.IEditorDecorationsCollection | undefined>(undefined);
    const completionManagerRef = useRef<DBMLCompletionManager | undefined>(undefined);
    ...
    const readOnlyDisposableRef = useRef<monaco.IDisposable | undefined>(undefined);
