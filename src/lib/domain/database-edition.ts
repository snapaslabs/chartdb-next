...
export const databaseEditionToImageMap: Record<DatabaseEdition, string> = {
    // PostgreSQL
    [DatabaseEdition.POSTGRESQL_SUPABASE]: SupabaseImage.src,
    [DatabaseEdition.POSTGRESQL_TIMESCALE]: TimescaleImage.src,

    // MySQL
    [DatabaseEdition.MYSQL_5_7]: MySql5_7Image.src,

    // SQL Server
    [DatabaseEdition.SQL_SERVER_2016_AND_BELOW]: SqlServerImage.src,

    // SQLite
    [DatabaseEdition.SQLITE_CLOUDFLARE_D1]: CloudflareD1Image.src,
};
